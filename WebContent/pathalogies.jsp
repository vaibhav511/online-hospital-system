...
<html>
<head>
<title>Pathology Reports List</title>
				...
				<div class="top-nav wow fadeInRight animated" data-wow-delay=".5s">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="pathalogies.jsp" class="active">Pathalogy</a></li>
							<li><a href="gallery1.jsp">Gallery</a></li>
							<li><a href="about.jsp">About</a></li>
							<li><a href="contact.jsp">Contact</a></li>
	...
	<div class="contact">
		<div class="container">
			<div class="contact-heading">
				<h2 class="wow fadeInDown animated" data-wow-delay=".5s">Pathology Reports</h2>
			</div>
			
			<div class="col-md-4 footer-nav wow fadeInRight animated"
				data-wow-delay=".5s">
				<%if((acctype!=null) && !(acctype.equals("Patient")))
			{ %><hr><a href="newpathalogies.jsp">Create Pathology Report</a><br>
				<hr>
				<%}
			...
			<br>
			<hr>
			<div align="center" class="top-nav wow fadeInRight animated"  style="margin-left: 100px; float: left;">
				<%
					...
					if ((acctype.equals("Admin")) || (acctype.equals("Doctor"))) {
						resultset = statement
								.executeQuery("select * from Pathology");
					} 
						...
						resultset = statement
								.executeQuery("select * from Pathology where patientid="
										+ patientid + "");
					}
				...
				<TABLE border="5"
					...
					<TR style="font-family: sans-serif;">
						<TH style="padding: 10px;">TestNo</TH>
						<TH style="padding: 10px;">TestName</TH>
						<TH style="padding: 10px;">TestDate</TH>
