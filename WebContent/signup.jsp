			...
			<div class="login-body">
				...
				<div class="login-info">
					...
					<%} %>
						...
						<input type="text" pattern="[0-9]{6}" title="Please enter 6 digit of zip." class="user" name="zip" placeholder="Zip" required="" >
						<input type="text" pattern="[0-9]{10}" title="Please enter 10 digits of mobile number." class="user" name="contact" placeholder="Contact No." required>
