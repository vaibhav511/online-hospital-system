	...
	<div class="contact">
		<div class="container">
			<div class="contact-heading">
				<h2 class="wow fadeInDown animated" data-wow-delay=".5s">List
					of Appointments</h2>
			...
			<div class="col-md-4 footer-nav wow fadeInRight animated"
				data-wow-delay=".5s">
				<a href="newappointment.jsp">New Appointment</a><br>
				<hr>
			...
			<div class="top-nav wow fadeInRight animated"  style="float: left;">
				<%
					...
					if (acctype.equals("Admin")) {
						...
						resultset1 = statement1
								.executeQuery("select DoctorID from Doctor where DEmail='"
										+ session.getAttribute("username") + "'");
						while (resultset1.next()) {
							System.out.print(resultset1.getString(1));

							doctorid = resultset1.getString(1);
						}

						resultset = statement
								.executeQuery("select * from appointments where doctorid="
										+ doctorid + "");
						...
						resultset = statement
								.executeQuery("select * from appointments where patientid="
										+ patientid + "");
					}
				...
				<TABLE border="5"
					...
					<TR style="font-family: sans-serif;">
						<TH style="padding: 10px;">ApntID</TH>
						<TH style="padding: 10px;">PatientID</TH>
						<TH style="padding: 10px;">DocterID</TH>
						<TH style="padding: 10px;">Department</TH>
						<TH style="padding: 10px;">AppointmentDate</TH>
						<TH style="padding: 10px;">AppointmentTime</TH>
						<TH style="padding: 10px;">IllnessDetails</TH>
						<TH style="padding: 10px;">TreatmentDetails</TH>
					...
					<TR>
						<form action="updateAppointments" method="post">
							...
							<TD><select name="status"
								style="color: black; margin: 0em 0em 0em 0em;" name="status">
									<%
							...
							<TD><input type="submit" name="update" value="Update"
								style="background-color: #04B404; color: white;"> <input
								type="hidden" name="appid" value="<%=resultset.getString(1)%>">
							</TD>
							...
							<td></td>
							<!--   <TD><input type="submit" name="delete" value="Delete" style="background-color:#DF3A01;"></TD> -->
						</form>
					</TR>
					<%
						resultset.next();
