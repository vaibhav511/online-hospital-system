		...
		<div class="container">
			<div class="login-body">
				...
				<div class="login-info">
					...
					<label name="error" style="color: red; font-family: sans-serif;"><%=request.getAttribute("error")%></label>
					<%} %>
						<input type="text" class="user" name="username" placeholder="Email" required="">
						<input type="password" name="password" class="lock" placeholder="Password">
						<label>Account Type</label>
						<select class="user" name="acctype" title="Select Type" >
						...
						<div class="signup-text">
							<a href="signup.jsp">Don't have an account? Create one now</a>
						</div>
						<hr>
						<h2>or login with</h2>
