					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							if(acctype==null){ %>
								...
								<li><a href="gallery1.jsp" class="active">Gallery</a></li>
		...
		<div class="gallery">
			<div class="container">
				<div class="gallery-heading">
					<h2>Gallery Page</h2>
					<p>Please take a few moments and browse through the photos of some of  Online Appointment System's recent events.</p>
				</div>
