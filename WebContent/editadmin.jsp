					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<%}if((acctype!=null) && (acctype.equals("Admin"))){ %>
								...
								<li><a href="editadmin.jsp">Profile</a></li>
			...
			<div class="login-body">
				...
				<div class="login-info">
					<form>
						...
						<input type="text" class="user" name="zip" placeholder="Zip" required="">
						<input type="text" class="user" name="contect" placeholder="Contact No." required="">
