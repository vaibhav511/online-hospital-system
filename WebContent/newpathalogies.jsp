...
<html>
<head>
<title>Create Pathology Report</title>
		...
		<div class="container">
			<div class="login-body">
				<div class="login-heading">
					<h1>New Pathalogy Report</h1>
				</div>
				<div class="login-info">
					<form action="PathologyRegistration" method="post">
					<%
					if((acctype!=null) && !(acctype.equals("Patient")))
					{
					...
					<%} %>
						...
						<select class="user" name="testName" title="Select Test" >
						<option>Blood Tests</option>
						<option>Stool Tests</option>
						<option>Urine Tests</option>
						<option>Other Tests</option>
						</select>
						<input type="date" class="user" name="testDate" placeholder="Test Date" required="">
						...
						<input type="text" class="user" name="txtDescription" placeholder="Description" required="">
						<input type="text" class="user" name="txtAmount"  pattern="\d*" title='Amount should be integer' placeholder="Amount" required="">
