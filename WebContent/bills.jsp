	...
	<div class="contact">
		<div class="container">
			<div class="contact-heading">
				<h2 class="wow fadeInDown animated" data-wow-delay=".5s">List of Bills</h2>
			</div>
			
			<div class="col-md-4 footer-nav wow fadeInRight animated"
				data-wow-delay=".5s">
				<%if((acctype!=null) && !(acctype.equals("Patient")))
			{ %><hr><a href="newbills.jsp">Create New Bills</a><br>
				<hr>
			...
			<div class="top-nav wow fadeInRight animated"  style="float: left;">
				<%
					...
					if ((acctype.equals("Admin")) || (acctype.equals("Doctor"))) {
						resultset = statement
								.executeQuery("select * from bills");
					} 
						...
						resultset = statement
								.executeQuery("select * from bills where patientid="
										+ patientid + "");
					}
				...
				<TABLE border="5"
					...
					<TR style="font-family: sans-serif;">
						<TH style="padding: 10px;">BillNo</TH>
						<TH style="padding: 10px;">BillDate</TH>
						<TH style="padding: 10px;">PatientID</TH>
						<TH style="padding: 10px;">DateOFAdmit</TH>
						<TH style="padding: 10px;">DateOfDischarge</TH>
						<TH style="padding: 10px;">RoomCharges</TH>
						<TH style="padding: 10px;">PathologyFee</TH>
						<TH style="padding: 10px;">DoctorFee</TH>
						<TH style="padding: 10px;">TotalAmount</TH>
						<TH style="padding: 12px;">Remarks</TH>
						<%
							if ((acctype.equals("Admin")) || (acctype.equals("Doctor")) || (acctype.equals("Patient"))) {
						%>
						<TH>Print</TH>
					...
					<TR>
						<form action="#" method="post">
							...
							<TD>
							<input type="submit" name="print" value="Print" style="background-color: #04B404; color: white;">
							 <input	type="hidden" name="appid" value="<%=resultset.getString(1)%>">
							</TD>
							</form>
					</TR>
					<%
