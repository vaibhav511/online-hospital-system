			...
			<div class="top-nav wow fadeInRight animated"  style="float: left;">
				...
				<TABLE border="5"
					...
					<TR style="font-family: sans-serif;">
						...
						<TH style="padding: 10px;">DEmail</TH>
						<TH style="padding: 10px;">DName</TH>
						<TH style="padding: 5px;">Department</TH>
						<TH style="padding: 5px;">AvailableTime</TH>
						<TH style="padding: 10px;">AvailableDays</TH>
						<TH style="padding: 10px;">DAddress</TH>
						<TH style="padding: 10px;">DCity</TH>
						<TH style="padding: 12px;">DZip</TH>
						<TH style="padding: 12px;">DContact</TH>
