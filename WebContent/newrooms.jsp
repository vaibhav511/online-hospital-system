		...
		<div class="container">
			<div class="login-body">
				...
				<div class="login-info">
					...
					<%} %>
						<input type="text" name="roomNo" pattern="^[0-9]{2}" title='Room number should two digit' class="user"  placeholder="Room No" required="true">
						
						
						<input type="text" class="user" pattern="\d*" title='Price should be integer'  name="roomPrice" placeholder="Room Price" required="true">
