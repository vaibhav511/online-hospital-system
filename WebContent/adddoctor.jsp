			...
			<div class="login-body">
				...
				<div class="login-info">
					<form action="Adddoctor">
						...
						<input type="text" class="user" pattern="[0-9]{6}" title="Please enter 6 digit of zip." name="zip" placeholder="Zip" required="">
						<input type="text" class="user"	pattern="[0-9]{10}"	title="Please enter 10 digits of mobile number." name="contact" placeholder="Contact No." required="">
						<input type="email" class="user" name="email" placeholder="Email"required="">
						<input type="text" class="user" pattern="[0-1][0-9][:][0-5][0-9]" title="Please enter HH:MM format." name="availabletime" placeholder="Available Time in HH:MM" required="">
						<h2>
							Available Days
							<hr>
							Sunday<input type="checkbox" value="Sunday" name="sunday">&nbsp;&nbsp;&nbsp;&nbsp;
							Monday<input type="checkbox" value="Monday" name="monday">&nbsp;&nbsp;&nbsp;&nbsp;
							Tuesday<input type="checkbox" value="Tuesday" name="tuesday">&nbsp;&nbsp;&nbsp;&nbsp;
							Wednesday<input	type="checkbox" value="Wednesday" name="wednesday">&nbsp;&nbsp;&nbsp;&nbsp;
							Thursday<input type="checkbox" value="Thursday"	name="thursday">&nbsp;&nbsp;&nbsp;&nbsp;
							Friday<input type="checkbox" value="Friday" name="friday">&nbsp;&nbsp;&nbsp;&nbsp;
							Saturday<input type="checkbox" value="Saturday"	name="saturday">
						</h2>
						<hr>
						<input type="password" name="password" class="lock"
							placeholder="Password" required> <input type="submit"
							name="Add" value="Submit">
